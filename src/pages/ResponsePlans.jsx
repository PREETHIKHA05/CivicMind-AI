      ...
      {showBroadcastModal && (
        <div className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-center justify-center p-4">
          <div className="glass-panel p-6 rounded-2xl border border-violet-500/40 max-w-xl w-full space-y-4 shadow-2xl">
            ...
            <div>
              <label className="text-xs font-mono text-slate-400 block mb-1">SMS message:</label>
              <textarea
            ...
            <div>
              <label className="text-xs font-mono text-slate-400 block mb-1">Recipient number:</label>
              <div className="space-y-2 rounded-xl border border-slate-800 bg-slate-950/80 p-3">
                {broadcastRecipients.map((number, index) => (
                  <div key={index} className="flex items-center gap-2 text-xs font-mono text-slate-300">
                    <span className="w-5 h-5 rounded-full bg-violet-950 text-violet-300 border border-violet-500/40 flex items-center justify-center text-[10px] font-bold">{index + 1}</span>
                    <span>{number}</span>
                  </div>
                ))}
              </div>
