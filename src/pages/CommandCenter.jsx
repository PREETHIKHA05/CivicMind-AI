  ...
  return (
    <div className="space-y-6 pb-12 text-black">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-2 border-b border-purple-100">
        <div>
          <h1 className="text-3xl font-black text-black tracking-tight">City Command Center</h1>
          <p className="text-sm text-black font-semibold">Location: {CITY_METADATA.name} — Ward 18 Corridor Focus</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
        {kpiCards.map((kpi, idx) => (
          ...
          >
            <span className="text-xs font-bold text-black tracking-wider block">
              {kpi.title}
            </span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="flex items-center justify-between pb-1">
            <h2 className="text-base font-bold text-black flex items-center gap-2 tracking-wider">
            ...
            {incidentsList.map((inc) => (
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4 p-3 bg-purple-50/40 border border-purple-100/60 rounded-xl text-sm">
                  <div>
                    <span className="text-xs font-bold text-black tracking-wider block mb-1">
                      Root Causes
                    </span>
                ...
                <div className="mt-4 p-3.5 rounded-xl bg-purple-50 border border-purple-200/60 flex items-start gap-3">
                  ...
                  <div className="flex-1">
                    <span className="text-xs font-bold text-purple-700 tracking-wider block mb-0.5">
                      Ai Assessment
                    </span>
        ...
        <div className="lg:col-span-5 space-y-5">
          ...
          <div className="bg-white p-5 rounded-2xl border border-purple-100 space-y-3 shadow-sm">
            <div className="flex items-center justify-between pb-2 border-b border-purple-100">
              <h3 className="text-sm font-bold text-black flex items-center gap-2 tracking-wider">
