...
export const DEPARTMENTS = [
  { id: "water", name: "Water Resources & Drainage", icon: "Droplets", color: "blue", status: "Critical Load" },
  { id: "traffic", name: "Traffic Management Bureau", icon: "Car", color: "amber", status: "Congested" },
  { id: "emergency", name: "Emergency Services (108)", icon: "Ambulance", color: "red", status: "Alert Route" },
  { id: "public", name: "Public Information & Advisory", icon: "Radio", color: "purple", status: "Broadcasting" },
  { id: "health", name: "Municipal Public Health", icon: "HeartPulse", color: "emerald", status: "Standby" }
];
